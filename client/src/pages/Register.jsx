    ...
    <div className="flex min-h-screen items-center justify-center bg-blueprint bg-grid px-6">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-ink/60">Forms, quizzes and exams — built in minutes.</p>
        </div>
        ...
        <div className="card space-y-4 p-6 bg-white shadow-xl border border-ink/5 rounded-2xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input required className="input" value={name} onChange={(e) => setName(e.target.value)} placeholder="Anil Sharma" />
            </div>
            <div>
        ...
        <p className="mt-5 text-center text-sm text-ink/60">
          ...
          <Link to="/login" className="font-semibold text-steel hover:text-steel-dark">
            Sign in
          </Link>
        </p>
      </div>
